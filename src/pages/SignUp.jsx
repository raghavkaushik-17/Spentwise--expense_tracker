  ...
  if (done) return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white border border-gray-200 rounded-2xl p-8 max-w-sm w-full text-center shadow-sm">
        ...
        <Link to="/signin" className="btn-primary inline-block mt-5">Go to sign in</Link>
      </div>
    </div>
  )
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 border border-gray-200 rounded-lg py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors mb-4"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" required value={fullName} onChange={e => setFullName(e.target.value)} className="input" placeholder="Rahul Sharma" />
            </div>
            <div>
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <Link to="/signin" className="text-accent-600 font-medium hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  )
